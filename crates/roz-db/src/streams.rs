...
pub async fn get_by_id(pool: &PgPool, id: Uuid) -> Result<Option<StreamRow>, sqlx::Error> {
...
pub async fn list(pool: &PgPool, tenant_id: Uuid, limit: i64, offset: i64) -> Result<Vec<StreamRow>, sqlx::Error> {
    sqlx::query_as::<_, StreamRow>(
